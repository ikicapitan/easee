...
Private Type PlayerRec
    ...
    'Velocidad EaSee Engine
    VelocidadCaminar As Long
    VelocidadCorrer As Long
...
Public Type TempPlayerRec
    ...
    'EaSee 0.5
    ConfusionTiempo As Long
    ConfusionDuracion As Long
    ParalisisTiempo As Long
    ParalisisDuracion As Long
    VenenoTiempo As Long
    VenenoDuracion As Long
    VenenoGolpe As Long
    VelocidadTiempo As Long
    VelocidadDuracion As Long
    VelocidadCaminar2 As Long
    VelocidadCorrer2 As Long
    VelocidadBuff As Long
    FuerzaTiempo As Long
    FuerzaDuracion As Long
    FuerzaH As Long
    BuffValor As Long
    DestrezaTiempo As Long
    DestrezaDuracion As Long
    DestrezaH As Long
    AgilidadTiempo As Long
    AgilidadDuracion As Long
    AgilidadH As Long
    InteligenciaTiempo As Long
    InteligenciaDuracion As Long
    InteligenciaH As Long
    VoluntadTiempo As Long
    VoluntadDuracion As Long
    VoluntadH As Long
    SpriteTiempo As Long
    SpriteDuracion As Long
    SpriteNumero As Long
    InvisibilidadTiempo As Long
    InvisibilidadDuracion As Long
    TransMapaH As Long
    TransMapaxH As Long
    TransMapayH As Long
End Type
...
Public Type TileRec
    ...
    Data2 As Long
    Data3 As Long
    Data4 As String 'En este caso usado para letreros
    DirBlock As Byte
    Cubo As Boolean
