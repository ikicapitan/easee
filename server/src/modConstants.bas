...
'VERSION CLIENTE NECESARIA
' Version constants
Public Const CLIENT_MAJOR As Byte = 2
Public Const CLIENT_MINOR As Byte = 1
...
Public Const MAX_SWITCHES As Long = 999
Public Const MAX_VARIABLES As Long = 999
Public Const MAX_PLAYER_PROJECTILES As Long = 1000
Public Const MAX_COMBAT As Byte = 8
Public Const MAX_COMBAT_LEVEL As Byte = 100
Public Const MAX_FRIENDS As Long = 25

'Elemental max's
Public Const MAX_ELEMENT_ATTACK = 4
Public Const MAX_ELEMENT_DEFENCE = 4
'Friend requests allowed to be made per player per 15 minutes
Public Const MAX_REQUESTS As Long = 5
'Combo system max amount of combos
Public Const MAX_COMBOS As Long = 100
...
Public Const TEXT_LENGTH As Integer = 1000
...
Public mensajeactualizar As Boolean 'evita que se envien una notificacion al insertar cubo
