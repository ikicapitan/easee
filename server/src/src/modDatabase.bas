...
Dim filename As String
    ...
    Open filename For Append As #1
        Print #1, "El siguiente error ha ocurrido en '" & procName & "' en '" & contName & "'."
...
Sub BanIndex(ByVal BanPlayerIndex As Long, ByVal BannedByIndex As Long)
    ...
    Close #F
    Call GlobalMsg(GetPlayerName(BanPlayerIndex) & " ha sido baneado de " & Options.Game_Name & " por " & GetPlayerName(BannedByIndex) & "!", White)
    Call AddLog(GetPlayerName(BannedByIndex) & " ha baneado a " & GetPlayerName(BanPlayerIndex) & ".", ADMIN_LOG)
...
Sub ServerBanIndex(ByVal BanPlayerIndex As Long)
    ...
    Call AddLog("El Servidor" & " ha baneado " & GetPlayerName(BanPlayerIndex) & ".", ADMIN_LOG)
    Call AlertMsg(BanPlayerIndex, "Has sido baneado por " & "el Servidor" & "!")
End Sub
