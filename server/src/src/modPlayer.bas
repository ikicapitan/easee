...
Sub JoinGame(ByVal index As Long)
    ...
    If GetPlayerAccess(index) <= ADMIN_MONITOR Then
        Call GlobalMsg(GetPlayerName(index) & " se ha unido a " & Options.Game_Name & "!", JoinLeftColor)
    Else
        Call GlobalMsg(GetPlayerName(index) & " se ha unido a " & Options.Game_Name & "!", White)
    End If
...
Sub LeftGame(ByVal index As Long)
    ...
    If TempPlayer(index).InGame Then
        ...
        If GetPlayerAccess(index) <= ADMIN_MONITOR Then
            Call GlobalMsg(GetPlayerName(index) & " ha abandonado " & Options.Game_Name & "!", JoinLeftColor)
        Else
            Call GlobalMsg(GetPlayerName(index) & " ha abandonado " & Options.Game_Name & "!", White)
        End If

        Call TextAdd(GetPlayerName(index) & " se ha desconectado de " & Options.Game_Name & ".")
                            ...
                            If Map(GetPlayerMap(index)).Tile(GetPlayerX(index), GetPlayerY(index) - 1).Type <> TILE_TYPE_KEY Or (Map(GetPlayerMap(index)).Tile(GetPlayerX(index), GetPlayerY(index) - 1).Type = TILE_TYPE_KEY And temptile(GetPlayerMap(index)).DoorOpen(GetPlayerX(index), GetPlayerY(index) - 1) = YES) Then
                                ...
                                If Player(index).Follower > 0 Then
                                    ...
                                    Else
                                        ...
                                        Call PlayerMsg(Player(index).Follower, "Debes estar proximo al objetivo para seguirlo.", Red)
                        ...
                        If Map(GetPlayerMap(index)).Tile(GetPlayerX(index), GetPlayerY(index) + 1).Type <> TILE_TYPE_RESOURCE Or GetPlayerAccess(index) > 0 And Player(index).WalkThrough = True Then
                            ...
                            If Map(GetPlayerMap(index)).Tile(GetPlayerX(index), GetPlayerY(index) + 1).Type <> TILE_TYPE_KEY Or (Map(GetPlayerMap(index)).Tile(GetPlayerX(index), GetPlayerY(index) + 1).Type = TILE_TYPE_KEY And temptile(GetPlayerMap(index)).DoorOpen(GetPlayerX(index), GetPlayerY(index) + 1) = YES) Then
                                ...
                                If Player(index).Follower > 0 Then
                                    ...
                                    Else
                                        'then stop the follower and tell them why
                                        Call PlayerMsg(Player(index).Follower, "Debes encontrarte proximo al objetivo para seguirlo.", Red)
                                        Player(index).Follower = 0
                                    End If
                                End If
                                Moved = YES
    ...
    With Map(GetPlayerMap(index)).Tile(GetPlayerX(index), GetPlayerY(index))
        ...
        If .Type = TILE_TYPE_HEAL Then
            ...
            If Not GetPlayerVital(index, VitalType) = GetPlayerMaxVital(index, VitalType) Then
                ...
                PlayerMsg index, "Restauras HP.", BrightGreen
        ...
        If .Type = TILE_TYPE_TRAP Then
            ...
            If GetPlayerVital(index, HP) - Amount <= 0 Then
                KillPlayer index
                PlayerMsg index, "Has sido victima de una trampa mortal.", BrightRed
            Else
                SetPlayerVital index, HP, GetPlayerVital(index, HP) - Amount
                PlayerMsg index, "Has sido herido por una trampa.", BrightRed
...
Function GiveInvItem(ByVal index As Long, ByVal itemnum As Long, ByVal ItemVal As Long, Optional ByVal sendupdate As Boolean = True) As Boolean
    ...
    If I <> 0 Then
        ...
        GiveInvItem = True
    Else
        Call PlayerMsg(index, "Inventario lleno.", BrightRed)
        GiveInvItem = False
    End If
...
Sub PlayerMapDropItem(ByVal index As Long, ByVal invNum As Long, ByVal Amount As Long)
    ...
    If (GetPlayerInvItemNum(index, invNum) > 0) Then
        If (GetPlayerInvItemNum(index, invNum) <= MAX_ITEMS) Then
            ...
            If I <> 0 Then
                ...
                If Item(GetPlayerInvItemNum(index, invNum)).Type = ITEM_TYPE_CURRENCY Or Item(GetPlayerInvItemNum(index, invNum)).Stackable > 0 Then
                    ...
                    Else
                        ...
                        Call MapMsg(GetPlayerMap(index), GetPlayerName(index) & " suelta " & Amount & " " & Trim$(Item(GetPlayerInvItemNum(index, invNum)).Name) & ".", Yellow)
                ...
                Else
                    ...
                    ' send message
                    Call MapMsg(GetPlayerMap(index), GetPlayerName(index) & " suelta " & CheckGrammar(Trim$(Item(GetPlayerInvItemNum(index, invNum)).Name)) & ".", Yellow)
                    Call SetPlayerInvItemNum(index, invNum, 0)
                    Call SetPlayerInvItemValue(index, invNum, 0)
                End If
            ...
            Else
                Call PlayerMsg(index, "Hay demasiados Objetos en el suelo.", BrightRed)
            End If
        End If
    End If
...
Sub CheckPlayerLevelUp(ByVal index As Long)
    ...
    If level_count > 0 Then
        If level_count = 1 Then
            'singular
            GlobalMsg GetPlayerName(index) & " ha ganado " & level_count & " nivel!", Brown
        Else
            'plural
            GlobalMsg GetPlayerName(index) & " ha ganado " & level_count & " niveles!", Brown
        End If
        SendEXP index
    ...
    If Map(GetPlayerMap(index)).Tile(x, y).Type = TILE_TYPE_RESOURCE Then
        ...
        If Resource_num > 0 Then
            If GetPlayerEquipment(index, Weapon) > 0 Then
                        ...
                        If Resource(Resource_index).Skill_LvlReq > 0 Then
                            If Resource(Resource_index).Skill_Req > 0 Then
                                If GetPlayerSkillLevel(index, Resource(Resource_index).Skill_Req) < Resource(Resource_index).Skill_LvlReq Then
                                    PlayerMsg index, "Nivel de habilidad insuficiente.", BrightRed
                                    Exit Sub
                                End If
                            End If
                        End If
                    End If
                        ...
                        If Resource(Resource_index).ItemReward > 0 Then
                            If FindOpenInvSlot(index, Resource(Resource_index).ItemReward) = 0 Then
                                PlayerMsg index, "Inventario lleno.", BrightRed
                                Exit Sub
                            End If
                        End If
                ...
                Else
                    PlayerMsg index, "Herramienta equipada incorrecta.", BrightRed
                End If
            ...
            Else
                PlayerMsg index, "Requiere una herramienta especifica.", BrightRed
            End If
        End If
    End If
End Sub
...
Dim EXP As Long
    ...
    If EXP < 0 Then EXP = 0
    If EXP = 0 Then
        Call PlayerMsg(index, "No pierdes Exp.", BrightRed)
    Else
        Call SetPlayerExp(index, GetPlayerExp(index) - EXP)
        SendEXP index
        Call PlayerMsg(index, "Pierdes " & EXP & " Exp.", BrightRed)
    End If
    ...
    If (GetPlayerInvItemNum(index, invNum) > 0) And (GetPlayerInvItemNum(index, invNum) <= MAX_ITEMS) Then
        ...
        Select Case Item(itemnum).Type
            Case ITEM_TYPE_ARMOR
                ...
                For I = 1 To Stats.Stat_Count - 2
                    If GetPlayerRawStat(index, I) < Item(itemnum).Stat_Req(I) Then
                        PlayerMsg index, "No reunes los requerimientos necesarios.", BrightRed
                        Exit Sub
                    End If
                Next
                ...
                If GetPlayerLevel(index) < Item(itemnum).LevelReq Then
                    PlayerMsg index, "Nivel insuficiente.", BrightRed
                    Exit Sub
                End If
                ...
                If Item(itemnum).ClassReq > 0 Then
                    If Not GetPlayerClass(index) = Item(itemnum).ClassReq Then
                        PlayerMsg index, "Clase incorrecta.", BrightRed
                        Exit Sub
                    End If
                End If
                ...
                If Not GetPlayerAccess(index) >= Item(itemnum).AccessReq Then
                    PlayerMsg index, "Nivel de acceso insuficiente.", BrightRed
                    Exit Sub
                End If
                ...
                If Item(itemnum).CombatTypeReq > 0 Then
                    If GetPlayerCombatLevel(index, Item(itemnum).CombatTypeReq) < Item(itemnum).CombatLvlReq Then
                        PlayerMsg index, "Nivel de Combate insuficiente.", BrightRed
                        Exit Sub
                    End If
                End If
                ...
                PlayerMsg index, "Te equipas " & CheckGrammar(Item(itemnum).Name), BrightGreen
            ...
            Case ITEM_TYPE_WEAPON
                ...
                For I = 1 To Stats.Stat_Count - 2
                    If GetPlayerRawStat(index, I) < Item(itemnum).Stat_Req(I) Then
                        PlayerMsg index, "No reunes los requisitos necesarios.", BrightRed
                        Exit Sub
                    End If
                Next
                ...
                If Map(GetPlayerMap(index)).Tile(x, y).Type = TILE_TYPE_KEY Then
                    ...
                    If itemnum = Map(GetPlayerMap(index)).Tile(x, y).Data1 Then
                        ...
                        If Map(GetPlayerMap(index)).Tile(x, y).Data2 = 1 Then
                            ...
                            Call PlayerMsg(index, "La llave se ha roto.", Yellow)
                        End If
                    End If
                End If
                        ...
                        If I <= GetPlayerLevel(index) Then
                            ...
                            If I > 0 Then
                                ...
                                If Not HasSpell(index, n) Then
                                    ...
                                    Call SendAnimation(GetPlayerMap(index), Item(itemnum).Animation, 0, 0, TARGET_TYPE_PLAYER, index)
                                    Call TakeInvItem(index, itemnum, 1)
                                    Call PlayerMsg(index, "Has aprendido " & Trim$(Spell(n).Name) & ".", BrightGreen)
                                Else
                                    Call PlayerMsg(index, "Ya has aprendido esta Habilidad.", BrightRed)
                                End If

                            Else
                                Call PlayerMsg(index, "No puedes aprender mas Habilidades.", BrightRed)
                            End If

                        Else
                            Call PlayerMsg(index, "Tu nivel debe ser " & I & " para aprender esta Habilidad.", BrightRed)
                        End If

                    Else
                        Call PlayerMsg(index, "Este Hechizo puede ser aprendido por " & CheckGrammar(GetClassName(Spell(n).ClassReq)) & ".", BrightRed)
                    End If
                End If
