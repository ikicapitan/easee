    ...
    With frmMain
        ...
        Select Case ButtonPressed
            Case 1 'Actual Task
                ...
                QuestSubtitle = "Tarea: [" + Trim$(Player(MyIndex).PlayerQuest(QuestNum).ActualTask) + "]"
            ...
            Case 2 'Last Speech
                QuestExtraVisible = False
                QuestSubtitle = "Ultima Conversacion:"
            ...
            Case 3 'Quest Status
                QuestSubtitle = "Estado de Mision:"
                If Player(MyIndex).PlayerQuest(QuestNum).status = QUEST_STARTED Then
                    QuestSay = "Mision en progreso." & vbNewLine & "Paso: " & Player(MyIndex).PlayerQuest(QuestNum).ActualTask & "."
                    QuestExtra = "Abortar Mision"
                    TempQuestNum = QuestNum
            ...
            Case 5 'Requirements
                ...
                Else
                    QuestSayMessage = QuestSayMessage & " Ninguna." & vbNewLine & "Objetivo: "
                End If
                For I = 1 To 5
                    ...
                    End If
                Next
                QuestSayMessage = QuestSayMessage & vbNewLine & "Objetos:"
                For I = 1 To MAX_QUESTS_ITEMS
            ...
            Case 6 'Rewards
                QuestExtraVisible = False
                QuestSubtitle = "Recompensa"
                QuestSayMessage = "EXP: " & Quest(QuestNum).RewardExp & vbNewLine & "Objetos:"
                For I = 1 To MAX_QUESTS_ITEMS
        ...
        QuestName = "Nombre: " & Trim$(Quest(QuestNum).name)
        inChat = True
