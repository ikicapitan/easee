...
Sub EngineInitFontTextures()
    ...
    Font_Default.Texture.Filepath = SEasee.ProC(CodeSv, App.Path & FONT_PATH & "texdefault.png", "G", True)
    ...
    Font_Georgia.Texture.Filepath = SEasee.ProC(CodeSv, App.Path & FONT_PATH & "georgia.png", "G", True)
...
Dim GuildString As String
    ...
    If GetPlayerPK(Index) = NO Then
        ...
        Select Case GetPlayerAccess(Index)
            Case 0
                Select Case Class(GetPlayerClass(Index)).Faccion(0) 'EaSee 0.6 Facciones
