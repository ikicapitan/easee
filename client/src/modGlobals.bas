...
'EaSee 0.5
Public ConfusionDuracion As Long
Public ParalisisDuracion As Long
Public VenenoDuracion As Long
Public VenenoGolpe As Long
Public VelocidadDuracion As Long
Public VelocidadCorrerH As Long
Public VelocidadCaminarH As Long
Public VelocidadBuff As Long
Public FuerzaDuracionP As Long 'Buff EaSee 0.5
Public FuerzaDuracionN As Long 'Debuff
Public DestrezaDuracionP As Long
Public DestrezaDuracionN As Long
Public AgilidadDuracionP As Long
Public AgilidadDuracionN As Long
Public InteligenciaDuracionP As Long
Public InteligenciaDuracionN As Long
Public VoluntadDuracionP As Long
Public VoluntadDuracionN As Long
Public SpriteDuracion As Long
Public InvisibilidadDuracion As Long
Public FuerzaH As Long
Public DestrezaH As Long
Public AgilidadH As Long
Public InteligenciaH As Long
Public VoluntadH As Long
Public BuffValor As Long
...
Public CountMenu As Long
Public PosMenu As Long
Public MoveMenu As Long
Public Alphamenu As Long
Public VisibleTextMenu As Long
Public TextNew As String
Public TextCreditos As String
